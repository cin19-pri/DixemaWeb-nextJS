      ...
      <header>
        <nav className="navbar">
          ...
          <ul className="nav-menu">
            ...
            <li className="nav-item">
              <a href="#skills" className="nav-link">Filosofía</a>
            </li>
            <li className="nav-item">
  ...
  <div className="section-content">
    ...
    <div className="about-details">
      ...
      <p className="text">
        ...
        vendedores y proveedores medianos en todo el país. Entendemos los
        desafíos únicos de tu negocio, desde encontrar socios comerciales
        confiables hasta optimizar la logística, es por eso que nace Dixema,
        una tienda en línea diseñada específicamente para la compra/venta de
        mayoreo. Selecciona, ordena y recibe sin salir de tu negocio.
      </p>
  ...
  <div className="row d-flex justify-content-between mx-0">
    ...
    >
      ...
      <p className="text-center">
        <br />
        Transformar el comercio mayorista en México ofreciendo una experiencia
        digital segura, rápida y confiable que conecte a vendedores y
        compradores, facilitando negocios de gran volumen y generando
    ...
    >
      ...
      <p className="text-center">
        <br />
        Liderar la evolución del comercio mayorista en México mediante un
        ecosistema digital B2B, donde cada empresa pueda acceder fácilmente a
        oportunidades mayoristas a través de una plataforma digital segura,
        transparente y preparada para transformar el comercio del futuro.
      </p>
    </div>
    ...
    >
      ...
      <ul className="text-center">
        <li style={{ padding: "10px", marginRight: "31px" }}>Confianza</li>
        <li style={{ padding: "10px", marginRight: "33px" }}>Eficiencia</li>
        <li style={{ padding: "10px" }}>Transparencia</li>
        <li style={{ padding: "10px", marginRight: "28px" }}>Seguridad</li>
        <li style={{ padding: "10px", marginRight: "22px" }}>Innovación</li>
      </ul>
    </div>
  </div>
</section>
        ...
        <div className="section-content">
          <ul className="gallery-list">
            <li className="gallery-item">
              <Image src="/images/gallery-1.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
            <li className="gallery-item">
              <Image src="/images/gallery-2.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
            <li className="gallery-item">
              <Image src="/images/gallery-3.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
            <li className="gallery-item">
              <Image src="/images/gallery-4.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
            <li className="gallery-item">
              <Image src="/images/gallery-5.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
            <li className="gallery-item">
              <Image src="/images/gallery-6.jpg" alt="Gallery Image" className="gallery-image" width={200} height={200}/>
            </li>
          </ul>
        </div>
      </section>
        ...
        <div className="section-content">
          <ul className="contact-info-list">
            <li className="contact-info">
              <p>Si tienes dudas o quieres unirte a nuestro equipo, contáctanos por los siguientes medios.</p>
            </li>
            <li className="contact-info">
          ...
          <form action="#" className="contact-form">
            ...
            <textarea placeholder="Mensaje" className="form-input" required></textarea>
      ...
      <footer className="footer-section">
        <div className="section-content">
          ...
          <p className="policy-text">
            <a href="#" className="policy-link">Política de privacidad</a>
