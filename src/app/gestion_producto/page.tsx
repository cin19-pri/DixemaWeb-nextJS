    ...
    <div className="dashboard-wrapper" key={pathname}>
      ...
      <aside className={`sidebar ${isMenuOpen ? "open" : ""}`}>
        ...
        <nav className="nav-menu">
          <Link href="/gestion_producto" className="nav-item active">
            Gestión
          </Link>
          <Link href="/dashboard" className="nav-item">
            Dashboard
          </Link>
          <Link href="/nuevo_producto" className="nav-item">
            Añadir nuevo producto
          </Link>
          <Link href="#" className="nav-item">
            Mensajería
          </Link>
          <Link href="/notificacionesprovedor" className="nav-item">
            Notificaciones
          </Link>
        ...
        <Link href="/login_proveedor" className="nav-item">
          Cerrar sesión
        </Link>
      </aside>
              ...
              <div key={prod.id} className="product-card">
                ...
                <div className="product-info">
                  ...
                  <p className="price-info">
                    ${prod.precio} MXN / {prod.unidades} unidades
                  </p>
                  <hr />
